  ...
  <div class="box-container">
    <?php
      if (isset($_GET['category'])) {
          ...
          foreach ($products as $product) {
           ?>
            ...
            <button style="color:white; font-weight: 900; padding: 5px; margin-bottom: 5px; font-size:20px; background-color:#E0163D; border-radius: 40px; cursor:pointer;" type="button" onclick="location.href='home.php';">Go Back</button>
              ...
              <h1 style="color: red;" class="category"><?= $product['category'] ?></h1>
              <div class="name"><?= $product['name'] ?></div>
              <div class="flex">
                <div class="price"><span style="color: red;">₱</span><?= $product['price'] ?></div>
        ...
        echo '<p class="empty" style="text-transform: uppercase;">Back to home and select category first!</p>';
      }
    ?>
  </div>
</section>
