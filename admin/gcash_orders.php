...
if (isset($_GET['delete'])) {
    ...
    header('location:gcash_orders.php');
}
...
<body>
    ...
    <section class="placed-orders">
        <h1 class="heading">GCASH Orders</h1>
        <div class="box-container">
            <!-- SELECTING/FETCHING GCASH ORDERS QUERY -->
            <?php
            $select_orders = $conn->prepare("SELECT * FROM `orders` WHERE method = 'GCASH'");
                    ...
                    <div class="box">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="flex-btn">
                                ...
                                <a href="gcash_orders.php?delete=<?=$fetch_orders['id'];?>" class="delete-btn" onclick="return confirm('Are you sure you want to delete this order?');">Delete</a>
                            </div>
                        </form>
                    </div>
                    <?php
