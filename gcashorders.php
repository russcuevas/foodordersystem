...
<head>
   ...
   <!-- FAVICON -->
   <link rel="shortcut icon" href="favicon/receipt.png" type="image/x-icon">
   <!-- FONT AWESOME LINK -->
            ...
            if ($select_orders->rowCount() > 0) {
                ...
                if ($fetch_orders['method'] == 'GCASH') {
                    ...
                    <div class="box">
                        ...
                        <p>Reference Number: <span style="color: red; text-decoration: underline;"><?=$fetch_orders['reference_number'];?></span></p>
